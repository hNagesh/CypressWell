...
# Last Updated By:
# Last Updated On:
# Feature Name: WELL Performance Rating Location
# Feature Description: Creating and validating Location for WELL Performance Rating
#------------------------------------------------------------------------------------
Feature: F05-WELL Performance Rating Location
    ...
    #Scenario-4
    @RegressionTest
    Scenario: Verifies Subset page in Location for WELL Performance Rating
        Given User is on Location page
